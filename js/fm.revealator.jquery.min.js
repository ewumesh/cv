...
$(function() {
    function a() { Revealator.busy || (Revealator.busy = !0, setTimeout(function() { Revealator.busy = !1, Revealator.refresh() }, 150)) }(Revealator = $.extend({}, { timer: null, busy: !1, scroll_padding: 0, effects_padding: 0, refresh: function() {} }, void 0 !== Revealator ? Revealator : {})).refresh = function() {
        var a = $(window),
            e = $(document),
            o = $(document.body),
    ...
    }, $(window).on("scroll resize load", function() { a() }), $(document).ready(function() { a() })
});